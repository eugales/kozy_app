...
class ProductEditPage extends StatefulWidget {
  ...
  const ProductEditPage({Key? key, required Product product})
      : _product = product,
        super(key: key);
...
class _ProductEditPageState extends State<ProductEditPage> {
  ...
  void initState() {
    ...
    priceController.text = widget._product.price.toString();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    void onProductSavePressed() {
      ...
      Product editedProduct = Product(
        ...
        price: price,
        sellerId: widget._product.sellerId,
      );

      _productsBloc.add(ProductEditEvent(product: editedProduct));
    }
